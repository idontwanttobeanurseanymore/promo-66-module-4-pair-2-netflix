...
INSERT INTO `actors_has_movies` VALUES (3,1),(1,2),(3,2),(2,3);
...
--
-- Table structure for table `users_loves_movies`
--

DROP TABLE IF EXISTS `users_loves_movies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `users_loves_movies` (
  `movies_idMovie` int NOT NULL,
  `users_idUser` int NOT NULL,
  `score` int DEFAULT NULL,
  PRIMARY KEY (`movies_idMovie`,`users_idUser`),
  KEY `fk_movies_has_users_users1_idx` (`users_idUser`),
  KEY `fk_movies_has_users_movies_idx` (`movies_idMovie`),
  CONSTRAINT `fk_movies_has_users_movies` FOREIGN KEY (`movies_idMovie`) REFERENCES `movies` (`idMovie`),
  CONSTRAINT `fk_movies_has_users_users1` FOREIGN KEY (`users_idUser`) REFERENCES `users` (`idUser`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `users_loves_movies`
--

LOCK TABLES `users_loves_movies` WRITE;
/*!40000 ALTER TABLE `users_loves_movies` DISABLE KEYS */;
INSERT INTO `users_loves_movies` VALUES (1,1,8),(2,1,9),(2,2,7);
/*!40000 ALTER TABLE `users_loves_movies` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-09 20:55:18
